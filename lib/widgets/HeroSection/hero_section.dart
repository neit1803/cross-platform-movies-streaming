...
class _HeroSectionState extends State<HeroSection>{
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Stack(
        children: [
          HeroImage(imgUrl: widget.datas[_currentIndex]['thumb_url'].toString()),
          HeroBanner(movieData: movieData, categoriesData: categoriesData, numberMovies: widget.datas.length, onDotClicked: (index) {
            setState(() {
              _currentIndex = index;
            });
          })

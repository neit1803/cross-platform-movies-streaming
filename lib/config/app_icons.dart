...
class AppIconsConfig {
  static const Icon searchIcon = Icon(Icons.search, color: Colors.white);
  ...
  static const Icon notifcationIcon = Icon(Icons.notifications_none_outlined, color: Colors.white,);
}
